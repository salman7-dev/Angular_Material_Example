...
class OwnerOperationLockServiceTest {
    ...
    fun allowsOnlyOneConcurrentOperationForSameOwner() {
        ...
        try {
            ...
            assertTrue(
                firstResult == "OPR-OWNER-CONCURRENT-001" ||
                secondResult == "OPR-OWNER-CONCURRENT-002"
            )
            ...
            assertTrue(
                state?.operationId == "OPR-OWNER-CONCURRENT-001" ||
                state?.operationId == "OPR-OWNER-CONCURRENT-002"
            )
        } finally {
            executor.shutdown()
        }
